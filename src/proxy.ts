...
const publicPaths = ["/", "/login", "/login.html", "/register", "/terms", "/privacy", "/forgot-password", "/reset-password", "/api/auth/login", "/api/auth/register", "/api/auth/login-form", "/api/auth/reset-request", "/api/auth/reset-password", "/api/contact", "/api/go/anthropic", "/portal", "/api/health", "/api/errors", "/superadmin", "/api/superadmin", "/api/admin/migrate-export-snapshots", "/api/cron/cleanup-imported-receipts"];
