    ...
    >
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "48px 24px" }}>
        ...
        <Section title="第1条（サービス概要）">
          <p>
            本規約は、ZeiFlow（以下「当社」）が提供する税務会計支援SaaSサービス「ZeiFlow」（以下「本サービス」）の利用条件を定めるものです。本サービスは、税理士事務所および会計事務所向けに、レシート・領収書のAI読み取り、仕訳データの管理、会計ソフト連携CSV/PDF出力、CSVインポート、クライアントポータル、仕訳ナレッジ管理、AI学習機能、およびレシート・仕訳の一括処理機能を提供します。
          </p>
        </Section>
        ...
        <Section title="第2条（利用登録）">
          ...
          <p style={{ marginTop: 12 }}>
            4.
            パスワードを忘れた場合、利用者は登録メールアドレス宛にパスワードリセットリンクの送信を申請することができます。リセットリンクの有効期限は発行から1時間です。
          </p>
        </Section>
        ...
        <Section title="第5条（クライアントポータル）">
          <p>
            1. 利用者は、本サービスのクライアントポータル機能を通じて、自らの顧問先（以下「クライアント」）に対し、レシート送信用の専用リンクを発行することができます。
          </p>
          <p style={{ marginTop: 12 }}>
            2. クライアントによるポータルの利用について、利用者は以下の責任を負うものとします。
          </p>
          <ul style={{ paddingLeft: 24, marginTop: 8 }}>
            <li>ポータルリンクの適切な管理（不要になった場合の無効化を含む）</li>
            <li>クライアントへの利用方法の説明</li>
            <li>クライアントがアップロードしたデータの確認・管理</li>
          </ul>
          <p style={{ marginTop: 12 }}>
            3. クライアントのポータル利用により発生するAPI利用料金は、リンクを発行した利用者が負担するものとします。
          </p>
        </Section>

        <Section title="第6条（AI学習機能）">
          <p>
            1. 本サービスは、利用者が確定した仕訳データをもとに、AIによる仕訳精度の向上を行います（以下「AI学習機能」）。
          </p>
          <p style={{ marginTop: 12 }}>
            2. AI学習は、各利用者および顧問先ごとに独立して行われ、他の利用者のデータと混合されることはありません。
          </p>
          <p style={{ marginTop: 12 }}>
            3. 利用者は、仕訳ナレッジ機能を通じてPDF・CSVファイルをアップロードし、AIの仕訳ルールをカスタマイズすることができます。
          </p>
          <p style={{ marginTop: 12 }}>
            4. AI学習機能およびナレッジから生成される仕訳は参考情報であり、最終的な判断は利用者の責任で行うものとします。
          </p>
        </Section>
